package com.hzgc.test.calculation;

import com.hzgc.test.util.JSONHelper;
import com.hzgc.test.util.LogEvent;
import com.hzgc.test.util.MergeUtil;
...
/**
 * 通过获取receive日志的最早时间和process日志的最晚时间，计算Ftp的吞吐量效率。
 * 需要修改receivePath和processPath路径。
 */
